                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="table-responsive" style="padding: 6px;margin-top: 5px;">
                                                <table class="table" id=" branchList">
                                                    ...
                                                    <tbody>
                                                        <%
                                                            if (request.getParameter("branchSearch") == null) {
                                                                ...
                                                                System.out.println("admin other error");
                                                            }
                                ...
                                <div class="tab-pane" role="tabpanel" id="tab-2">
                                    <div class="card shadow">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6 text-nowrap">
                                                    <div id="dataTable_length-2" class="dataTables_length" aria-controls="dataTable"><label class="form-label d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex d-xxl-flex justify-content-center align-items-center justify-content-sm-center align-items-sm-center justify-content-md-center align-items-md-center justify-content-lg-start align-items-lg-center justify-content-xl-start align-items-xl-center justify-content-xxl-center align-items-xxl-center"><input type="search" id="vehicleSearch" class="form-control form-control-sm" aria-controls="dataTable" placeholder="Search" style="width: 200px;"><button class="btn btn-primary" data-bss-disabled-mobile="true" data-bss-hover-animate="pulse" id="vehicleCategorySearchBtn" type="button" style="background: rgba(78,115,223,0);border-color: rgba(255,255,255,0);"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-search" style="margin-top: 0px;margin-left: 0px;width: 16px;color: rgb(197,195,195);">
                                                                <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"></path>
                                                                </svg></button></label></div>
                                                </div>
                                                <div class="col-md-6">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body" style="text-align: left;">
                                                                        <form action="admin/p-vehicleCategory-add.jsp" method="post">
                                                                            ...
                                                                            <div><button class="btn btn-primary d-block w-100" id="createVehicleCategoryBtn" type="submit" style="background: #e9b546;border-color: #e9b546;">Create</button><button class="btn btn-primary d-block w-100" id="createVehicleCategoryBtn-1" type="submit" style="background: #e9b546;border-color: #e9b546;margin-top: 5px;">Update</button></div>
                                                                        </form>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <tbody>
                                                        <%      if (request.getParameter("branchSearch") == null) {
                                                                for (VehicleCat vc : proxy.vehicleCategoryList()) {
                                                                    ...
                                                                    out.print("<div><button class=\"btn btn-primary d-block w-100\" id=\"createVehicleCategoryBtn-3\" type=\"submit\" style=\"background: #e9b546;border-color: #e9b546;margin-top: 5px;\">Update</button></div>");
                                                                    out.print("</form>");
                                                                    out.print("</div>");
                                                                    out.print("</div>");
                                                                    out.print("</div>");
                                ...
                                <div class="tab-pane" role="tabpanel" id="tab-3">
                                    <div class="card shadow">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6 text-nowrap">
                                                    <div id="dataTable_length-3" class="dataTables_length" aria-controls="dataTable"><label class="form-label d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex d-xxl-flex justify-content-center align-items-center justify-content-sm-center align-items-sm-center justify-content-md-center align-items-md-center justify-content-lg-start align-items-lg-center justify-content-xl-start align-items-xl-center justify-content-xxl-center align-items-xxl-center"><input type="search" id="vehicleSearch" class="form-control form-control-sm" aria-controls="dataTable" placeholder="Search" style="width: 200px;"><button class="btn btn-primary" data-bss-disabled-mobile="true" data-bss-hover-animate="pulse" id="vehicleSearchBtn-1" type="button" style="background: rgba(78,115,223,0);border-color: rgba(255,255,255,0);"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-search" style="margin-top: 0px;margin-left: 0px;width: 16px;color: rgb(197,195,195);">
                                                                <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"></path>
                                                                </svg></button></label></div>
                                                </div>
                                                <div class="col-md-6">
