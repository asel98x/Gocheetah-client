                        ...
                        <div class="card mb-5">
                            <div class="card-body p-sm-5">
                                ...
                                <form action="p-destination-update.jsp" method="post">
                                    ...
                                    <div class="text-start d-md-flex justify-content-md-start align-items-md-center mb-3" id="adminBranch" style="border: 1px outset rgb(209,211,226);border-radius: 5.6px;"><i class="fas fa-car text-start" style="border-left-color: rgb(133, 135, 150);margin-left: 5px;"></i><select class="form-select" id="vehicle" style="border-color: rgba(33,37,41,0);" required="" name="vehicle" value="<%out.print(vehicle);%>">
                                            <%          for (Vehicle vh : proxy.viewVehicles()) {
                                                    if (vehicle.equals(vh.getCategory())) {

                                                        out.print("<option selected=\"\">" + vh.getCategory()+ "</option>");

                                                    } else {
                                                        out.print("<option>" + vh.getCategory() + "</option>");
                                                    }
                                                }
                                            %>
                                        </select></div>
