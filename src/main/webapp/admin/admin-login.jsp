<%-- 
    ...
    Created on : Sep 2, 2022, 2:37:47 PM
    Author     : asel
--%>
...
<body style="background: rgb(248,249,251);">
    ...
    <header class="bg-primary-gradient pt-5" style="background: #F8F9FB;margin-top: 79px;">
        <div class="container text-start" style="padding: 20px;margin-top: 0px;background: #f8f9fb;">
            <div class="row">
                <div class="col-md-6" data-aos="fade" data-aos-duration="300" data-aos-delay="200" data-aos-once="true" style="background: url(&quot;../assets/img/admin-pic.png&quot;) center / contain no-repeat;">
                    <div></div>
                </div>
                <div class="col-md-6" style="padding: 50px;">
                    <form class="text-center" method="post" action="a-p-login.jsp">
                        <p data-aos="fade" data-aos-delay="100" style="font-size: 25px;font-weight: bold;text-align: center;">Admin login</p>
                        <div class="mb-3"><input class="form-control" type="email" data-aos="zoom-out-right" data-aos-delay="200" data-aos-once="true" id="adminEmail" name="adminEmail" placeholder="Email" style="border-color: rgb(233,181,70);" required=""></div>
                        <div class="mb-3"><input class="form-control" type="password" data-aos="zoom-out-right" data-aos-delay="300" id="adminPword" name="password" placeholder="Password" required="" style="border-style: solid;border-color: rgb(233,181,70);" minlength="8"></div>
                        <div class="mb-3"><button class="btn btn-primary d-block w-100" data-aos="zoom-out-right" data-aos-delay="500" id="adminLoginBtn" type="submit" style="background: rgb(233,181,70);border-color: rgb(233,181,70);">Login</button></div>
                    </form>
                </div>
            </div>
        </div>
